...
document.addEventListener("DOMContentLoaded", function () {
	...
	mir.onclick = function () {
		isActivatePointer=!isActivatePointer;
		if(isActivatePointer){
			const cursor = document.querySelector("#cursor")
			cursor.setAttribute("class","activeCursor")
			...
			cursor.setAttribute("class","inactiveCursor")
